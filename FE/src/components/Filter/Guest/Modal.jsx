...
const Modal = ({
  options: { setIsRender = null, contents = "", hasContents = false, clearHandler = null, saveHandler = null },
}) => {
  ...
  return (
    <ModalWrapper>
      ...
      <ButtonsWrapper>
        <Buttons>
          <ClearButton highlighted underlined disabled={!hasContents} onClick={setIsRender}>
            {CLEAR_BUTTON_TEXT}
          </ClearButton>
          <Button secondary onClick={setIsRender}>
            {SAVE_BUTTON_TEXT}
          </Button>
        </Buttons>
      </ButtonsWrapper>
